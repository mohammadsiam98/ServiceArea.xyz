                                            ...
                                            <div>
                                                <form action="{{route('admin.abouts.update',$abouts->id)}}" enctype="multipart/form-data" method="POST">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea id="my-editor" name="details" cols="30" rows="10" class="form-control">{{ $abouts->details }} </textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="file" class="filestyle" data-btnClass="btn-primary" id="image" name="download_cv" placeholder="upload your PDF">
                                                        <img src="{{url($abouts->pdf)}}" class="img-thumbnail" style="height: 70px;width:auto;">
                                                    </div>
